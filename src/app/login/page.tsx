...
export default function LoginPage() {
  ...
  const onLoginSubmit = async () => {
    try {
      ...
      dispatch({ type: 'auth/setCredentials', payload: { token: result.token } });
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground p-4">
      <Card className="w-full max-w-md p-8 space-y-6 bg-bg-panel border border-white/8 rounded-r16 shadow-lg">
        ...
        <h2 className="text-3xl font-bold text-center text-primary">Bem-vindo(a) de volta!</h2>
        <p className="text-center text-muted-foreground">Entre na sua conta ByteBank.</p>
